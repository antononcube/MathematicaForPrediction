...
This document discusses concrete algorithms for two different approaches of mandala, [1], images generation: direct construction with graphics primitives, and use of machine learning algorithms.
...
The request of [3] is generation of mandalas for coloring by hand. That is why the mandala generation algorithms are in the grayscale space. Coloring the generated mandala images is a secondary task.
...
Here is are black-and-white mandala images.
    ...
    SeedRandom[6567]
    ImageCollage[Table[Image@MandalaByLayers[16, 20], {12}], 
     Background -> White, ImagePadding -> 3, 
     ImageSize -> 1200]
...
Here are some colored mandalas. (Which make me think more of Viking and Native American art than mandalas.)
    ...
    ImageCollage[Table[Image@MandalaByLayers[16, 20, True], {12}], 
     Background -> White, ImagePadding -> 3, 
     ImageSize -> 1200]
...
!["www-nnmfBlendedImages-12"](http://imgur.com/5iylBng.png)
