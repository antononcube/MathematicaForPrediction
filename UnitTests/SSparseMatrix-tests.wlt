...
VerificationTest[(* 7 *)
  RowNames @ ToSSparseMatrix[ SparseArray[rmat], "RowNames" -> Automatic]
  ,
  ToString /@ Range[ RowsCount @ rmat  ]
  ,
  TestID -> "RowNames-2"
];
...
VerificationTest[(* 7 *)
  ColumnNames @ ToSSparseMatrix[ SparseArray[rmat], "ColumnNames" -> Automatic]
  ,
  ToString /@ Range[ ColumnsCount @ rmat  ]
  ,
  TestID -> "ColumnNames-2"
];
