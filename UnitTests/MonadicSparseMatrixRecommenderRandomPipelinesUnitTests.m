...
MakeSMRMonRandomPipelines[ {dfTitanic_Dataset, dfMushroom_Dataset}, n_Integer ] :=
    Module[{stage1, stage2, stage3, stage4, stage5, stage6, allStages, pipelines},
      ...
      stage4 = {
        ...
        SMRMonGetTopRecommendations[ Normal @ RandomSample[ dfMushroom[All, "id"], 12 ] ],
        SMRMonGetTopRecommendations[ AssociationThread[ Normal @ RandomSample[ dfMushroom[All, "id"], 7], RandomReal[{0, 1}, 7] ] ],
        SMRMonGetTopRecommendations[ {"brown", "foul"} ],
        SMRMonGetTopRecommendations[ AssociationThread[ {"brown", "foul"}, { 1, 0.1 } ] ],
